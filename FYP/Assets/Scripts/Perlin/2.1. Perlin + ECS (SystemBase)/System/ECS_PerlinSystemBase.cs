...
public class ECS_PerlinSystemBase : SystemBase
{
    private ECS_PerlinManagerSystemBase perlinManager;

    protected override void OnUpdate()
    {
        if (!perlinManager)
        {
            perlinManager = ECS_PerlinManagerSystemBase.instance;
        }
        if (perlinManager)
        {
            ...
            Entities.ForEach((ref Translation position, ref ECS_CubeDataSystemBase cubeData) =>
            {
